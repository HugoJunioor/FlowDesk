  ...
  return (
    <div className="bg-gradient-to-r from-primary/15 via-primary/10 to-primary/15 border-b border-primary/30 px-4 py-2 flex items-center justify-center gap-3 text-sm">
      ...
      <span className="text-foreground/90">
        <strong className="text-primary">MODO DEMO</strong> · dados fictícios ·
        login: <code className="px-1.5 py-0.5 rounded bg-background/60 font-mono text-xs">master</code> /
        senha: <code className="px-1.5 py-0.5 rounded bg-background/60 font-mono text-xs">Admin@1</code>
      </span>
      <button
